...
const AddEducation = ({addEducation,history}) =>{
    ...
    return(
      ...
      <p className="lead">
        <i className="fas fa-code-branch"></i> Add any School or collages
      </p>
      ...
      <form className="form" onSubmit={e =>{
        ...
        <div className="form-group">
          <input type="text" placeholder="* School or collages" name="school" value={school} onChange={e=> onChange(e) } required />
        </div>
        <div className="form-group">
